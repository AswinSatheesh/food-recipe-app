...
public class InstructionsAdapter extends RecyclerView.Adapter<InstructionsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull InstructionsViewHolder holder, int position) {
        ...
        holder.recycler_instuction_steps.setHasFixedSize(true);
        holder.recycler_instuction_steps.setLayoutManager(new LinearLayoutManager(context,LinearLayoutManager.VERTICAL,false));
        InstructionStepAdapter stepAdapter = new InstructionStepAdapter(context,list.get(position).steps);
        holder.recycler_instuction_steps.setAdapter(stepAdapter);
...
class InstructionsViewHolder extends RecyclerView.ViewHolder {
    ...
    RecyclerView recycler_instuction_steps;
    public InstructionsViewHolder(@NonNull View itemView) {
        super(itemView);
        textView_instruction_name = itemView.findViewById(R.id.textView_instruction_name);
        recycler_instuction_steps = itemView.findViewById(R.id.recycler_instuction_steps);
